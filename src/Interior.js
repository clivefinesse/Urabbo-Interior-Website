         ...
         <div style={{backgroundColor:theme,opacity:"0.95",height:"auto"}}>
           <div className="row mt-5 p-3">
             <div className="col-12 col-md-6 mx-auto text-left">
               ...
               <p className="text-white">HAVENCRAFT's ability to stay abreast of the latest in interior design industry coupled with the ingenuity and imagination of Urabbo interior experienced professionals has made Home Makers Interior Designers & Decorators Private Limited a dominant player in this market. HAVENCRAFT has successfully completed a diverse range of projects throughout India for hotels, restaurants, financial institutions, hospitality installations, corporate facilities and luxury homes. Urabbo Interior customers are located in communities such as Nairobi, Kikuyu, Mombasa, Nakuru, Kajiado, Westlands, and many other cities of Kenya. Whether it is a prestigious office, luxury home, casual cafe or an upscale restaurant, the HAVENCRAFT Interior team of interior Designer is equally at ease to carry out any type of project from initial planning to final implementation. One of Home Makers primary responsibilities is to focus on all the key elements in your home or office space. The next step is to create a functional environment in each of these elements that optimizes space and finally, create a unique design solution that relates to the client's vision while maintaining a balance between functionality and aesthetics. Whether it's a bedroom, washroom, kitchen, living area or hallway in your home or the bar, restrooms, waiting areas, kitchen and dining areas in a restaurant or office set up in a corporate building, HAVENCRAFT Interior Design professionals have unique and innovative design solutions for any type of outfit. Home Makers ensure that our design will create a stunning first impression when your guests enter your home for the first time. Home Makers will create just the perfect decor and ambiance in your restaurant or hotel that will entice your customers to keep coming back. Home Makers focus on ergonomically designed office space with a stress-free environment which will help increase employee productivity. You can actually view and appreciate examples of the finest work in residential & commercial interior design </p>
             </div>
            ...
            <div className="col-12 col-md-6 mx-auto text-left">
             ...
             <div className="col-12 col-md-6 mx-auto text-left">
               ...
               <p className="text-white">Havencraft is one of the finest companies that design and execute modular kitchens. As a process, our top most priority is to understand your requirements and challenges that you face and basis those we provide designs that are most suitable for you. Our designs are deep rooted in the Indian culture and we understand the sensibilities of a kenyan kitchen and usage patterns. We use high-quality products that are heat proof and termite resistant. The need for storage is highly demanded in most of the kitchens and our designs take special care of maximising the storage space. As we give a lot of importance to size specifications and quality, our modular kitchens are easier to install as the measurements are accurate. The panels of the modular kitchen are carefully delivered to your doorstep, unpacked and installed. The whole process is a delight as there is no time wastage. once the designs are locked, we get into execution. We are a one stop solution provider when it comes to full home interior designing and particular room interior for partial home interior designing. </p>
             </div>
             <div className="col-10 col-md-4 mx-auto">
               <img src="/images/inti3.jpg" className="rounded mt-5 border border-3 border-warning" width="100%">HAVENCRAFT CONSTRUCTION LIMITED</img>
             </div>
